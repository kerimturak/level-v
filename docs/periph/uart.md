# UART Controller — Technical Documentation
...
4. [TX Module](#tx-module)
5. [RX Module](#rx-module)
6. [Baud Rate Calculation](#baud-rate-calculation)
...
The `uart` module implements a **full-duplex UART** controller with TX and RX FIFO buffers for asynchronous serial communication.
...
When `LOG_UART` is defined at compile time, TX output is logged to a file:
