...
Sections:
  1. CORE PARAMETERS      - Core CPU settings
  2. CACHE PARAMETERS     - Cache configuration
  3. BRANCH PREDICTOR     - Branch predictor parameters
  4. PERIPHERAL           - UART, GPIO, etc.
  5. BUS PARAMETERS       - Wishbone bus settings
  6. MEMORY MAP           - Address map
  7. OPCODES              - RISC-V opcode definitions
  8. ENUMERATIONS         - All enum types
  9. STRUCTURES           - All struct types
  10. FUNCTIONS           - Helper functions
================================================================================
*/
`timescale 1ns / 1ps
