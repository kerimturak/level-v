...
Modified for level-V RV32IMC_Zicsr processor
*/
#include "coremark.h"
...
static void uart_init(void)
{
    ...
    /* Control register format: [31:16] baud_div, [1] rx_en, [0] tx_en */
...
portable_init(core_portable *p, int *argc, char *argv[])
{
    ...
    ee_printf("\n\n");
    ee_printf("=================================\n");
    ee_printf("CoreMark on level-V RV32IMC_Zicsr\n");
    ee_printf("=================================\n");
