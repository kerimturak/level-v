# Level RISC-V Architecture Test Environment

This directory contains the target-specific environment files for running
riscv-arch-test compliance tests on the Level RV32IMC_Zicsr processor.

## Files

- `model_test.h` - Target-specific macros (RVMODEL_HALT, RVMODEL_DATA_BEGIN, etc.)
- `link.ld` - Linker script for Level memory map

## Supported Extensions

The Level processor supports the following ISA extensions:
