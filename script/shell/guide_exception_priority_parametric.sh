...
#    grep "EXC_PRIORITY" rtl/pkg/level_param.sv
#
...
echo "📍 Current configuration in rtl/pkg/level_param.sv:"
echo ""
grep -A 6 "^  localparam exc_priority_t EXC_PRIORITY" /home/kerim/level-v/rtl/pkg/level_param.sv | head -20
echo ""
...
echo "  1. Edit rtl/pkg/level_param.sv"
...
echo ""
echo "  script/shell/run_level_exception_priority_tests.sh"
...
echo "   # Edit rtl/pkg/level_param.sv, then:"
