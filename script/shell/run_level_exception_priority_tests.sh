...
# =============================================================================
#
# This script demonstrates how to build and test the Level RTL with different
# exception priority orders and compare results against Spike.
#
# USAGE:
#   ./run_level_exception_priority_tests.sh [MODE] [TEST_NAME]
#
# MODES:
...
#
# EXAMPLES:
#   ./run_level_exception_priority_tests.sh default breakpoint
#   ./run_level_exception_priority_tests.sh misaligned_first ma_addr
#   ./run_level_exception_priority_tests.sh disabled_debug illegal
#
# =============================================================================
