...
# The OpenSRAM generator sets the timing table index_1 upper bound (0.04 ns)
# as max_transition. This 40 ps value is not a real physical limit,
# only the upper end of the characterization range.
# SKY130 standard cells use 1.5 ns; SRAM pins support this as well.
# If left unfixed, OpenLane Step 16 reports RSZ-0090.
# See: macros/<MACRO_NAME>/README.md
