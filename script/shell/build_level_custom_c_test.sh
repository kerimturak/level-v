...
# ============================================================================
# This script compiles and runs custom C test programs.
# Usage:
...
check_prerequisites() {
    ...
    if [ ! -f "$LINKER_SCRIPT" ]; then
        ...
        # If no default linker script, we can use -Wl,-Ttext flags
    fi
}
...
run_simulation() {
    ...
    # Format: Vlevel_wrapper <max_cycles> +INIT_FILE=<file>
    local VERILATOR_BIN="./build/obj_dir/Vlevel_wrapper"
