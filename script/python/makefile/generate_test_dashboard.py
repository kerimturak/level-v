...
def generate_dashboard_html(tests, output_path, title="Level Test Dashboard"):
...
<body>
    ...
    <footer class="footer">
        <p>Level RISC-V Processor — Test Verification Dashboard</p>
        <p>Generated by Level Test Suite</p>
    </footer>
...
Examples:
  ...
  %(prog)s --results-dir ./results --simulator verilator --output dashboard.html
    ...
    parser.add_argument("--title", default="Level Test Dashboard",
