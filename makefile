...
help:
	...
	@echo -e ""
	@echo -e "$(GREEN)Reports & Dashboard:$(RESET)"
	@echo -e "  html            - Generate HTML test dashboard"
	@echo -e "  open_dashboard  - Generate and open in browser"
	@echo -e ""
	...
	@echo -e "  make quick                # Quick smoke test (~5 min)"
	@echo -e "  make full                 # Full regression (~30 min)"
	@echo -e "  make nightly              # Nightly build (full + benchmarks)"
	@echo -e "  make coverage             # Full coverage analysis"
	@echo -e "  make t T=rv32ui-p-add     # Single ISA test"
